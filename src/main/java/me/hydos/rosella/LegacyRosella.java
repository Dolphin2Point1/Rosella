...
public class LegacyRosella {
    ...
    public LegacyRosella(InitializationRegistry registry, Display display, String applicationName, int applicationVersion) {
        // TODO remove
    ...
    @Deprecated
    public LegacyRosella(Display display, String applicationName, boolean enableBasicValidation) {
    ...
    @Deprecated
    public LegacyRosella(Display display, List<String> requestedValidationLayers, String applicationName, DebugLogger debugLogger) {
