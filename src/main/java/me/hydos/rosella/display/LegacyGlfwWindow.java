 ...
 */
public class LegacyGlfwWindow extends Display {
    ...
    private LegacyGlfwWindow() {
        super(0, 0);
    }

    public LegacyGlfwWindow(int width, int height, String title, boolean canResize) {
        super(width, height);
    ...
    @Override
    public void startAutomaticLoop(LegacyRosella rosella) {
...
//            System.out.println(fps);
    ...
    public static class SuppliedGlfwWindow extends LegacyGlfwWindow {
